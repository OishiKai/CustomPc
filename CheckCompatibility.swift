...
//        let chipset = motherboard.specs["tipset"]
//
...
//        }
//
//        let cpuSocket = cpu.specs["socket"].replacingOccurrences(of: "ソケット形状 ", with: "").replacingOccurrences(of: "Socket ", with: "")
//        let motherboardSocket = motherboard.specs["socket"].replacingOccurrences(of: "CPUソケット", with: "").replacingOccurrences(of: "Socket", with: "")
//
